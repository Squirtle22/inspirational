...
function generateQuote(event) {
    ...
    let prompt = `Generate an inspirational quote about ${instructionsInput.value}`;
    ...
    quoteElement.innerHTML = `<div class="generating">⏳ Generating your inspirational quote...</div>`;
